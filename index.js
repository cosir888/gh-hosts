...
const generateHosts = (configs) => {
  let hostStr = "# Generated by hosts-generator start(hosts生成开始：) \n\n";
  configs.forEach((i) => {
...
//   });    
  ...
  const updateTime = new Date(Date.now()).toLocaleString('zh-cn',{hour12:false});//修改为24小时制
  hostStr += `\n# 最新更新时间: ${updateTime}\n`;
  hostStr += "# 请关注原作者: https://github.com/fliu2476/gh-hosts.git\n";
  hostStr += "# Generated by hosts-generator end（文件生成结束）";
  return {
    hostStr,
    updateTime,
  };
